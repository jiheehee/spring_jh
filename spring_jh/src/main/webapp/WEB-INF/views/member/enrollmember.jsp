...
<div id="enroll-container">
         <%-- <form name="memberEnrollFrm" action="${path }/member/enrollend.do" method="post">
         ...
         <springform:form name="memberEnrollFrm" action="${path }/member/enrollend.do" method="post"
            modelAttribute="member">
            <springform:input path="userId" 
               type="text" class="form-control" placeholder="아이디 (4글자이상)" name="userId" id="userId_" required="true"/>
            <springform:errors path="userId" cssClass="error"/>
            
            <springform:input path="password" 
               type="password" class="form-control" placeholder="비밀번호" name="password" id="password_" required="true"/>
            <springform:errors path="password" cssClass="error"/>
            <input type="password" class="form-control" placeholder="비밀번호확인" id="password2" required/>
            
            <springform:input path="userName"
                type="text" class="form-control" placeholder="이름" name="userName" id="userName" required="true"/>
            ...
            <springform:input path="email"
                type="email" class="form-control" placeholder="이메일" name="email" id="email" required="true"/>
            <springform:errors path="email" cssClass="error"/>
            <springform:input path="phone"
                type="tel" class="form-control" placeholder="전화번호 (예:01012345678)" name="phone" id="phone" maxlength="11" required="true"/>
            ...
            <springform:select path="gender" class="form-control" name="gender" required="true">
